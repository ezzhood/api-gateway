...
class MessageBroker {
     ...
     */
    sendRpc(queue, msg, options
    // onCallback: (msg: ConsumeMessage) => void
    ) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                yield this.send(queue, msg, options);
                yield this.consume(options.replyTo, msg => {
                ...
                reject(new errorResponse_1.ErrorResponse('Could not retrieve data', 503));
            }));
        });
    }
}
